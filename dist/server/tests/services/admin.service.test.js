...
describe("AdminService Unit Tests", () => {
    ...
    it("should update lead status and create audit log", async () => {
        ...
        const mockRepo = {
            ...{},
            updateLeadStatus: async (id, status) => makeMockLead({ id, status })
        };
        const dummyAuditLog = async (input) => {
    ...
    it("should create service and log action", async () => {
        ...
        const mockRepo = {
            ...{},
            createService: async (data) => makeMockService(data)
        };
