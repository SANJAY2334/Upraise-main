...
adminRouter.patch("/leads/:id/status", validate({ params: idParamSchema, body: statusSchema }), adminController.updateLeadStatus);
// Contact Messages
...
adminRouter.patch("/services/:id", validate({ params: idParamSchema, body: serviceSchema.partial() }), adminController.updateService);
...
adminRouter.patch("/projects/:id", validate({ params: idParamSchema, body: projectSchema.partial() }), adminController.updateProject);
